...
$sql = "SELECT * FROM reuniones ORDER BY fechas";
								...
								<div class="tiles">
									<article class="tile" style="background-color: <?php echo $color ?>">
										...
										<form action="mostrar_curso.php" method="POST">
											<input type="hidden" name="curso_id" value="<?php echo $row['id_reunion']; ?>">
											<button>
												<span>Asistir </span>
							...
							?>
								<div class="tiles">
									<article class="tile" style="background-color: <?php echo $color ?>">
										...
										<form action="mostrar_reunion.php" method="POST">
											<input type="hidden" name="curso_id" value="<?php echo $fila['id_reunion']; ?>">
											<button>
												<span>Asistir </span>
												<span class="icon-button">
													<i class="ph-caret-right-bold"></i>
